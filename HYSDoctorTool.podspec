...
Pod::Spec.new do |spec|
  ...
  spec.homepage     = "https://github.com/RMJKDevelopment/HYSDoctorSDK-iOS.git"
  ...
  spec.source       = { :git => "https://github.com/RMJKDevelopment/HYSDoctorSDK-iOS.git", :tag => "#{spec.version}" }
  ...
  spec.vendored_frameworks = 'HYSDoctorSDK-iOS/*.framework'
